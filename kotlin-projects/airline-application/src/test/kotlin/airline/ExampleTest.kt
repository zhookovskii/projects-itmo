...
class ExampleTest {
    ...
    fun testSimple() {
        ...
        testAndCancel {
            ...
            checkEmails("kbats@itmo.ru", flightId, "1A", "successfully purchased")
    ...
    fun testBooking() {
        ...
        testAndCancel {
            ...
            checkEmails("kbats@itmo.ru", flightId1, "2B", "successfully purchased")
            ...
            checkEmails("test@example.com", flightId1, "2B", "could not be purchased")
            Assertions.assertEquals(setOf("1A", "1B", "2A"), booking.freeSeats(flightId1, flightTime))
            ...
            checkEmails("kbats@itmo.ru", flightId1, "could not be purchased")
            Assertions.assertEquals(setOf("1A", "1B", "2A"), booking.freeSeats(flightId1, flightTime))
            ...
            checkEmails("kbats@itmo.ru", flightId2, "successfully purchased")
            ...
            sleep()
            checkEmails("test@hello.com", "could not be purchased")
            ...
            sleep()
            checkEmails("ipetrov@mail.ru", "could not be purchased")
